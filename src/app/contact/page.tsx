        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-orange hover:bg-orange/90 text-white py-3 px-6 rounded-md font-semibold transition-colors"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Honey Lane<br />Sweet Valley, SV 12345</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@zamzoom.com</p>
                  </div>
                </div>
              </div>
            </div>
